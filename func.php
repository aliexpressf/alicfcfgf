...
function gotoaliexpress($productid, $sub_tracking=""){
			if(ALIEXPRESS_AFFILIATE_KEY == "dafamedia"){
				$tracekey= "Fiem2zR&dp=".urlencode($sub_tracking);//campaign for subnetwork
			}else{
				$tracekey= ALIEXPRESS_AFFILIATE_KEY;
			}
	$urlproduct= 'http://www.aliexpress.com/item/-/'.$productid.'.html';
	$gotourl="http://s.click.aliexpress.com/deep_link.htm?dl_target_url=".urlencode($urlproduct)."&aff_short_key=".$tracekey;
	return $gotourl;
}
